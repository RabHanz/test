        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={3}>
            <Box sx={{ position: 'sticky', top: 24 }}>
              ...
              <Paper sx={{ p: 2, mb: 3 }}>
                {/* TODO: Replace this placeholder with the real LeadCaptureForm implementation */}
                <div className="p-4 border rounded shadow">
                  <h2 className="text-lg font-semibold">Lead Capture Form Placeholder</h2>
                  <p>This is a placeholder for the real LeadCaptureForm component.</p>
                </div>
              </Paper>
