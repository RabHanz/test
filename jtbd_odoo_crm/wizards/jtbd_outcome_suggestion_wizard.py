...
class JtbdOutcomeSuggestionWizard(models.TransientModel):
    ...
    def create(self, vals_list):
        # ... (Keep existing create override logic) ...
    ...
    # _get_suggestions method remains the same
    def _get_suggestions(self, mapping, suggestion_type):
        # ... (Keep existing _get_suggestions logic) ...
        suggestions = []
        if not mapping or not mapping.job_category: return suggestions
        job_category = mapping.job_category
        patterns = self.env['jtbd.outcome.pattern'].search([('job_category', '=', job_category), ('active', '=', True)], limit=1)
                ...
                for i, item in enumerate(selected_items):
                     ...
                     if item_name.strip() and item_name not in existing_metrics:
                        ...
                        vals = {
                            ...
                            # FIX: Use numerical key '2' for Medium priority
                            'priority': '2',
