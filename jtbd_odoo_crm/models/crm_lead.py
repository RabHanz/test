...
class CrmLead(models.Model):
    ...
    # --- Deferred Phase 1 Fields ---

    # Agency Profile Fields (Ref: PRD Phase 1 / Process Flow A1)
    ...
    # Technology Stack Fields (Ref: PRD Phase 1 / Process Flow A2)
    ...
    # Basic Marketing/Intent Fields (Ref: PRD Phase 1 / Process Flow A3, B)
    ...
    # We already have jtbd_signal_strength (populated by Force Analysis)
    # We might add a separate 'jtbd_initial_intent_score' later if needed
    # For now, jtbd_signal_strength covers the combined score concept

    # --- End of Deferred Phase 1 Fields ---