...
class JtbdAdditionalOutcome(models.Model):
    ...
    # --- Field for Value Realization Context ---
    value_driver = fields.Selection(
        [('revenue_increase', 'Revenue Increase'),
         ...
         ('other', 'Other')],
        string="Primary Value Driver", index=True,
        help="The main business value category this outcome contributes to."
    )
