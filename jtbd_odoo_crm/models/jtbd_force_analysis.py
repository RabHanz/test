...
class JtbdForceAnalysis(models.Model):
    ...
    def _compute_momentum(self):
        ...
        for record in self:
            ...
            resistance_forces = record.anxiety_score + record.habit_score # Updated resistance
    ...
    def action_update_opportunity(self): # Unchanged logic, uses updated scores
        self.ensure_one()
    ...
    # --- Helper Methods ---
    def _notify_success(self, message): # Keep helper
