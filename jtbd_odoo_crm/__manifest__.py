# -*- coding: utf-8 -*-
{
    ...
    'description': """Phase 1, 2 & 3 Complete: Core JTBD fields, Wizards (Job Statement, Force Add, Outcome Suggest/Template, Trace Link Create), Analysis Tools (Force, Outcome), Foundational Models (Patterns, Integration, Evolution, Content, Portfolio, Transfer, Trace Link, Analytics, Config), Project Integration, Basic Feedback Triggers, Enhanced CRM Views.""",
    ...
    'data': [
        ...
        # Model Views (Order less critical, but group logically)
        'views/jtbd_job_pattern_views.xml',
        'views/jtbd_outcome_pattern_views.xml',
        'views/jtbd_common_force_description_views.xml', # Added view for this
