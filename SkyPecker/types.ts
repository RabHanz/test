...
export interface GameSettings {
  ...
  showPerformanceCounter: boolean;
  showSpeedDifficulty: boolean;
  showFPSInGame: boolean;
  audioTestEnabled: boolean;
...
export interface GameEngineProps {
  ...
  initialScore?: number;
  initialCoinsThisRun?: number;
  initialDifficulty?: number;
  initialGameSpeed?: number;
  initialPerfectRun?: boolean;
  initialPowerGauge?: number; // Added
  initialEnemiesDefeatedThisRun?: number; // Added
  initialPowerupsUsedThisRun?: number; // Added
  initialLastMilestoneScoreAwarded?: number; // Added
  initialHasRevived?: boolean; // Added
}
...
export interface GameState {
  ...
  perfectRun: boolean;
  currentScene: string;
  gameSpeed?: number; // Add if needed
  powerGauge?: number; // Add if needed
  // lastMilestoneScoreAwarded?: number; // If you want GameEngine to track this precisely
  // hasRevived?: boolean; // If App needs to know this from GameEngine
}
