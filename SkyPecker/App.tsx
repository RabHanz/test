...
const saveProgress = useCallback(() => {
  ...
  useEffect(() => {
    ...
    const needsNewChallenge = !dailyChallenge || 
      (lastDailyChallengeCompleted && lastDailyChallengeCompleted !== todayStr && dailyChallenge.completedToday) || 
      (!dailyChallenge.completedToday && lastDailyChallengeCompleted !== todayStr);
    ...
    if (needsNewChallenge) {
      ...
      // Adaptive challenge difficulty based on player skill
  ...
  }, [mode, dailyChallenge, lastDailyChallengeCompleted, playerStats.skillLevel]);
