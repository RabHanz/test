...
class JtbdTraceLink(models.Model):
    ...
    provenance_id = fields.Many2one(
        'jtbd.data.provenance', string='Data Provenance Ref (Optional)', index=True, ondelete='set null',
        help="Optional link to the specific data provenance record related to the source artifact."
    )
