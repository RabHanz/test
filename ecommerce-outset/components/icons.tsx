...
export const CogIcon = (props: React.SVGProps<SVGSVGElement>) => ( // For Operational Excellence
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15.036-7.026A7.5 7.5 0 0112 4.5v1.5m0 0a7.5 7.5 0 00-6.036 2.974m6.036-2.974A7.5 7.5 0 0112 19.5v-1.5m0 0a7.5 7.5 0 006.036-2.974M12 19.5a7.5 7.5 0 01-6.036-2.974m12.072-7.026A7.5 7.5 0 0012 4.5v1.5m0 0a7.5 7.5 0 016.036 2.974M12 4.5a7.5 7.5 0 00-6.036 2.974M12 19.5v-1.5" />
  </svg>
);
...
export const MegaphoneIcon = (props: React.SVGProps<SVGSVGElement>) => ( // For showcase, marketing
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-.94 1.11-.94h1.093c.55 0 1.02.398 1.11.94l.149.894c.07.424.384.764.78.93.398.164.855.142 1.205-.108l.737-.527a1.125 1.125 0 011.45.12l.773.774c.39.389.39 1.024 0 1.414l-.527.737c-.25.35-.272.806-.107 1.204.165.397.505.71.93.78l.893.15c.543.09.94.56.94 1.11v1.093c0 .55-.397 1.02-.94 1.11l-.893.149c-.425.07-.765.383-.93.78-.165.398-.143.854.107 1.204l.527.738c.39.39.39 1.024 0 1.414l-.774.773a1.125 1.125 0 01-1.449.12l-.738-.527c-.35-.25-.806-.272-1.203-.107a4.493 4.493 0 01-.932.78l-.149.894c-.09.542-.56.94-1.11.94h-1.093c-.55 0-1.02-.398-1.11-.94l-.149-.894a4.493 4.493 0 01-.93-.78c-.398-.165.854-.143 1.205.107l.737.527a1.125 1.125 0 011.45.12l.773-.773a1.125 1.125 0 010-1.414l-.527-.737c-.25-.35-.272-.806-.107-1.204.165-.397.506-.71.93-.78l.894-.15c.542-.09.94-.56.94-1.11v-1.093zM12 18a6 6 0 100-12 6 6 0 000 12z" />
  </svg>
);
