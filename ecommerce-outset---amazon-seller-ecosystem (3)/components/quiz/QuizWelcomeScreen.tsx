...
const QuizWelcomeScreen: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-4 md:p-8">
      <h1 className="text-3xl md:text-4xl font-bold text-orange-400 mb-4">Discover Your Amazon Seller Persona</h1>
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-md space-y-4">
        ...
        <div className="flex items-start space-x-2 text-left">
          ...
          <div>
            ...
            {consentError && <p className="text-red-400 text-sm mt-1">{consentError}</p>}
          </div>
        </div>
